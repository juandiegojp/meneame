...
<body>
    ...
    $sent = $pdo->prepare('SELECT * from noticias WHERE noticias_usuarios = :id ORDER BY id DESC');
    $sent->execute([':id' => $id]);
    ?>
    ...
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                Tus noticas
                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Estas son tus noticias de mierda, ¡FELICIDADES!</p>
            </caption>
